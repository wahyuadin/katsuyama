            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('login') }}" class="app-brand-link gap-2">
                    <img src="{{ asset('assets/img/logo-kfi.png') }}" width="200" alt="">
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form class="mb-3" action="{{ route('submit') }}" method="POST">
                @csrf
                <div class="mb-3">
                  <label class="form-label">ID Card</label>
                  <input type="text" class="form-control" name="id_card" value="{{ $rememberDeviceDecoded ? $rememberDeviceDecoded->id_card : '' }}" placeholder="Masukan ID Card" autofocus required>
                </div>
